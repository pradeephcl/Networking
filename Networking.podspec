...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/pradeephcl/Networking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'pradeephcl' => 'kumarprad@hcl.com' }
  s.source           = { :git => 'https://github.com/pradeephcl/Networking.git', :tag => s.version.to_s }
